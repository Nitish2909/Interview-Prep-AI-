      ...
      <div className="w-full min-h-full bg-[#EFFCEF]">
        ...
        <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-fit md:w-1/2 pr-4 mb-8 md:mb-0">
            ...
            <div className="w-full md:w-1/2">
              <p className="text-[17px] text-gray-900 md:mr-20 mb-6">
                Get role-specific question, Expand your answer when you need
                them, Dive deeper into concept and organize everything your way.
                From Prepare to mastery- Your ultimate toolkit is here.
              </p>
              <button
