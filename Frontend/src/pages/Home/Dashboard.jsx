...
const Dashboard = () => {
  ...
  return (
    <DashboardLayout>
      <div className="">
         <div className="flex justify-end mr-5"><Link className=" relative top-5 mt-3 z-20  h-10 gap-3 bg-orange-500 text-white px-7 py-2.5 rounded-full shadow-lg hover:bg-orange-600 transition-all" to="/search">Search</Link></div>
      <div className="container mx-auto pt-4 pb-4 px-4 relative ">
