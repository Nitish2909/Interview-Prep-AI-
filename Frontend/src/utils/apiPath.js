...
export const BASE_URL = "https://interview-prep-ai-ammy.onrender.com";
...
export const API_PATHS = {
  ...
  AI: {
    GENERATE_QUESTIONS: "/api/ai/generate-questions", // Generate interview questions and answers using OpenAi

    GENERATE_EXPLANATION: "/api/ai/generate-explanation", // Generate concept explanation using OpenAi
  },
