...
const SummaryCard = ({
  ...
  return (
    <div className="bg-white border border-b-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group" onClick={onSelect}>
      <div className="rounded-lg p-4 cursor-pointer relative" style={{ background: colors?.bgcolor || "#f3f4f6" }}
>
      ...
      <div className="px-3 pb-3">
        <div className="flex items-center gap-3 mt-4">
          ...
          <div className="text-[10px] font-medium text-black px-3 py-1 border-[0.5px] border-gray-900 rounded-full">LastUpdated: {lastUpdated}</div>
        </div>
        {/* Description */}
        <p className="text-[12px] text-gray-500 font-medium line-clamp-3 mt-3">{description}</p>
      </div>
    </div>
  );
};
